      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="rounded-lg p-8 flex flex-col items-center gap-6"
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-xl font-bold" style={{ color: "var(--wow-gold-bright)" }}>Link Battle.net</h1>
          ...
          <div className="w-full space-y-3">
            ...
            <button onClick={() => router.push("/")}
              ...
              onMouseOver={e => (e.currentTarget.style.color = "var(--wow-text-muted)")}
              onMouseOut={e => (e.currentTarget.style.color = "var(--wow-text-faint)")}>
              Skip for now →
            </button>
          </div>

          <p className="text-xs text-center" style={{ color: "var(--wow-text-faint)" }}>
