      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="rounded-lg p-8 flex flex-col gap-5"
          ...
          <div className="flex flex-col items-center gap-2 mb-1">
            ...
            <h1 className="text-xl wow-heading text-center" style={{ color: "var(--wow-gold-bright)" }}>New Password</h1>
          </div>

          {!token ? (
            <div className="text-center">
              <p className="text-sm" style={{ color: "#c84040" }}>Invalid reset link.</p>
              <Link href="/forgot-password" className="text-sm mt-3 block" style={{ color: "var(--wow-gold)" }}>Request a new one →</Link>
            </div>
          ) : done ? (
            <div className="text-center space-y-2">
              <p className="text-sm" style={{ color: "var(--wow-text)" }}>✅ Password updated! Redirecting…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                <label className="block text-xs mb-1.5 uppercase tracking-widest" style={{ color: "var(--wow-text-faint)" }}>New Password</label>
